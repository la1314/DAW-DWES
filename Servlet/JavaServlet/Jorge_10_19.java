...
public class Jorge_10_19 extends HttpServlet {
    public void doGet(HttpServletRequest peticion, HttpServletResponse respuesta) throws ServletException, IOException {
       
        respuesta.setContentType("text/html");
        if (peticion.getParameter("DNI") == null) {
            ...
            salida.println("<FORM ACTION='/Proyecto1/Jorge_10.19' METHOD='GET'>");
            salida.println("Título");
            ...
            try {
                ...
                while (misresultados.next()) {
                    salida.println("<TR><TD>" + misresultados.getString("DNI") + "\n<TD>"
                            ...
                            + "\n<TD>" + misresultados.getFloat("plus"));
                }
                salida.println("</TABLE></BODY></HTML>");
                miconexion.close();
