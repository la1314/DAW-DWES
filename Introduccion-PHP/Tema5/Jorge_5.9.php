<html>
    <head>
        ...
        <style type="text/css">
            ...
            /*Modificaciones para el ejercicio 5.9*/
            span.paloma2 {
                font-weight: bold;
                color: pink;
            }
    ...
    <body>
        ...
        <h1>
            ...
            } while ((abs($palomaX-$paloma2X)<$tamañoMapa/2)&&(abs($palomaY-$paloma2Y)<$tamañoMapa/2));
            ...
            do
            {
                       ...
                       if ($x == $palomaX && $y == $palomaY)
                        {
                            ...
                            echo '<span class="paloma2">%</span>'; #Paloma
                        }
                        else
                        {
                ...
                echo "palomax2=$paloma2X paloma2Y=$paloma2Y</div>\n";
