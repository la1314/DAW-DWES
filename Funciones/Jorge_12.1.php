...
<body>
    ...
    <h1>
        ...
        function comprobarDistancia($casa, $paloma, $tamañoMapa){

            return (abs($casa - $paloma) < $tamañoMapa / 2);
        }
        ...
        } while ( comprobarDistancia($casaX, $palomaX, $tamañoMapa) && comprobarDistancia($casaY, $palomaY, $tamañoMapa) );
